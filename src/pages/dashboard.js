      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 ">
              ...
              <div className="relative w-32 h-32 border-8 border-teal-500 rounded-full">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <span className="block text-sm text-gray-500">Oxygen</span>
                  </div>
                </div>
              </div>
        ...
        <div className="col-span-2 bg-white p-6 rounded-xl backdrop-blur-lg shadow-xl hover:border-2 hover:border-green-500">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-gray-800 font-medium">Diabetes Risk</span>
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-gray-800 font-medium">Obesity Risk</span>
